...
sealed class CustomError : Exception() {
    ...
    data class GeohashNotStored(override val message: String = "Geohash has not been stored") :
        CustomError()
    ...
    data class UserNotLoggedIn(override val message: String = "User is not logged in") :
        CustomError()

    data class BeaconNotStored(override val message: String = "Beacon has not been stored") :
        CustomError()

    data class LocationUnavailable(override val message: String = "Could not determine location. Ensure GPS is enabled.") :
        CustomError()
